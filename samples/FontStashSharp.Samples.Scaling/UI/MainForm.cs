...
namespace FontStashSharp.Samples.UI
{
	public partial class MainForm
	{
		...
		private void Update()
		{
			...
			_top.Scale = new Vector2(_spinButtonScale.Value.Value, _spinButtonScale.Value.Value);
			_bottom.Scale = new Vector2(_spinButtonScale.Value.Value, _spinButtonScale.Value.Value);
